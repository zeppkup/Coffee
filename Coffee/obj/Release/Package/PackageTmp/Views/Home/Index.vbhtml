            ...
            <fieldset>
                ...
                <table>
                    <tr>
                        ...
                        <td rowspan="2" style="width:10%;">เพิ่มoption</td>
                    ...
                    <tr ng-repeat="x in list_coffee_order_main_detail">
                        ...
                        <td style="width:10%;">
                            <div class="row">
                                <input type="button" data-toggle="collapse" data-target="#option{{$index}}" value="เพิ่มรายละเอียด" ng-click="setindex_order_detail($index)" />
